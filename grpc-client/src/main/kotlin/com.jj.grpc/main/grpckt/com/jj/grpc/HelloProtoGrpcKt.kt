...
import com.jj.grpc.HelloServiceGrpc.getServiceDescriptor
...
/**
 * Holder for Kotlin coroutine-based client and server APIs for com.jj.grpc.HelloService.
 */
object HelloServiceGrpcKt {
  ...
  /**
   * A stub for issuing RPCs to a(n) com.jj.grpc.HelloService service as suspending coroutines.
   */
  ...
  /**
   * Skeletal implementation of the com.jj.grpc.HelloService service based on Kotlin coroutines.
   */
  abstract class HelloServiceCoroutineImplBase(
    coroutineContext: CoroutineContext = EmptyCoroutineContext
  ) : AbstractCoroutineServerImpl(coroutineContext) {
    /**
     * Returns the response to an RPC for com.jj.grpc.HelloService.sayHello.
     *
    ...
    open suspend fun sayHello(request: HelloRequest): HelloResponse = throw
        StatusException(UNIMPLEMENTED.withDescription("Method com.jj.grpc.HelloService.sayHello is unimplemented"))
